...
LIA_SPKTOOLS_API void baggedSegments(SegCluster &selectedSegments,RefVector<SegCluster> &baggedA,double & baggedProbability,unsigned long minimumLength,unsigned long maximumLength);
